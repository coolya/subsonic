            ...
            <table width="100%" class="bottomspace">
                ...
                <tr class="table-altrow">
                    ...
                    <td>The list type. Must be one of the following: <code>random</code>, <code>newest</code>,
                        <code>highest</code>, <code>frequent</code>, <code>recent</code>.</td>
                </tr>
                <tr>
                    <td><code>size</code></td>
                    <td>No</td>
            ...
            <table width="100%" class="bottomspace">
                ...
                <tr class="table-altrow">
                    ...
                    <td>The operation to perform. Must be one of: <code>get</code>, <code>start</code>, <code>stop</code>,
                        <code>skip</code>, <code>add</code>, <code>clear</code>, <code>remove</code>, <code>shuffle</code>, <code>setGain</code></td>
                </tr>
                <tr>
                ...
                <tr class="table-altrow">
                    ...
                    <td>No</td>
                    <td></td>
                    <td>Used by <code>add</code>. Comma-separated list of song IDs to add to the jukebox playlist.</td>
                </tr>
                <tr>
