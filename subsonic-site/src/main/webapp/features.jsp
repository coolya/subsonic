    ...
    <div class="content">
        ...
        <div class="description">
            <ul class="list">
                ...
                <li>Select from 20 different themes, including some that are optimized for HD screens.</li>
    ...
    <div class="content">
        ...
        <div class="description">
            <ul class="list">
                ...
                <li>Find cover art and lyrics using web services from Discogs and Chartlyrics.</li>
