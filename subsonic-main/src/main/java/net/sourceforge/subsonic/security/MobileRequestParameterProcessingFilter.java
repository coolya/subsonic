 ...
 * @author Sindre Mehus
 */
public class MobileRequestParameterProcessingFilter implements Filter {

    private static final Logger LOG = Logger.getLogger(MobileRequestParameterProcessingFilter.class);
