...
public class AdService {
    ...
    private final String[] ads = {
            ...
            "<iframe src='http://subsonic.sourceforge.net/subsonic-ad.php' width='180' height='400' scrolling='no' border='0' marginwidth='0' style='border:none;' frameborder='0'></iframe>"
    };
