        ...
        <div id="main-col">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="featuretable bottomspace"
                ...
                <tr class="table-heading">
                    <th class="featurename">Latest stable release &ndash; Subsonic 3.6</th>
                    <th>Download</th>
                    <th>Instructions</th>
                </tr>
                <tr class="table-altrow">
                    <td class="featurename">Windows installer</td>
                    <td><a href="http://prdownloads.sourceforge.net/subsonic/subsonic-3.6-setup.exe"><img
                ...
                <tr>
                    ...
                    <td><a href="http://prdownloads.sourceforge.net/subsonic/subsonic-3.6-standalone.tar.gz"><img
                            src="inc/img/download_small.gif" alt="Download" height="11" width="11"/> Download</a></td>
                ...
                <tr class="table-altrow">
                    ...
                    <td><a href="http://prdownloads.sourceforge.net/subsonic/subsonic-3.6-war.zip"><img
                            src="inc/img/download_small.gif" alt="Download" height="11" width="11"/> Download</a></td>
